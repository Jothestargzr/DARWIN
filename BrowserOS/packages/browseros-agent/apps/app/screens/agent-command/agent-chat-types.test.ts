...
function historyItem(
  overrides: Partial<DARWINChatHistoryItem>,
): DARWINChatHistoryItem {
  return {
    id: 'session-1:0',
    role: 'user',
    text: 'Hello',
...
function page(items: DARWINChatHistoryItem[]): AgentHistoryPageResponse {
  return {
    agentId: 'main',
    sessionKey: 'session-1',
    session: null,
