...
export const MCPServerHeader: FC<MCPServerHeaderProps> = ({
  ...
  const handleRestart = async () => {
    ...
    try {
      const { getDARWINAdapter } = await import('@/lib/browseros/adapter')
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="mb-1 flex items-center justify-between">
            <h2 className="font-semibold text-xl">DARWIN MCP Server</h2>
            <a
              href={DOCS_URL}
              target="_blank"
          ...
          <p className="mb-6 text-muted-foreground text-sm">
            Connect DARWIN to MCP clients like Claude Code, Gemini CLI and
            others.
          </p>
