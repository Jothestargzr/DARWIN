...
/**
 * Permanent DARWIN neo pitch on the MCP settings page — deliberately no dismiss
 ...
 * to this page, so a user can arrive having just read the generic DARWIN neo
    ...
    <div className="flex items-center gap-4 rounded-xl border border-border bg-card p-4 shadow-sm transition-all hover:shadow-md">
      ...
      <div className="min-w-0 flex-1">
        <p className="font-semibold text-sm">
          For better MCP support, use DARWIN neo
        </p>
