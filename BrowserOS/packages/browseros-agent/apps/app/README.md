# DARWIN Agent Extension

[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg)](../../../../LICENSE)

The built-in browser extension that powers DARWIN's AI interface — new tab with unified search, side panel chat, onboarding, and settings. Built with [WXT](https://wxt.dev) and React.
...
- **Side Panel Chat**: Full-featured chat interface for interacting with DARWIN
...
The extension communicates with the [DARWIN Server](../../apps/server/) running locally. The server handles the AI agent loop, MCP tools, and CDP connections — the extension provides the UI layer.
...
- **AI Suggestions**: Context-aware DARWIN action suggestions
- **Top Sites**: Quick access to frequently visited sites
- **Theme Toggle**: Light/dark mode support

### Side Panel (`sidepanel/`)

The main chat interface for DARWIN:
...
- DARWIN Server running locally (for full functionality)
...
DARWIN agent extension releases are built as signed CRX artifacts through
the reusable `Release: Extensions (CRX)` workflow. The normal DARWIN product
