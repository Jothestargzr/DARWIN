...
export class DARWINAdapter {
  private static instance: DARWINAdapter | null = null

  private constructor() {}

  static getInstance(): DARWINAdapter {
    if (!DARWINAdapter.instance) {
      DARWINAdapter.instance = new DARWINAdapter()
    }
    return DARWINAdapter.instance
  }
...
/** @public */
export const getDARWINAdapter = () => DARWINAdapter.getInstance()
