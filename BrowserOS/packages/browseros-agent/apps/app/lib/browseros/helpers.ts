...
/**
 * Returns the local DARWIN server base URL for chat and agent APIs.
 * DARWIN publishes this through the unified MCP/server-port preference.
 */
