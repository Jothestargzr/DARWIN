...
const MockDARWINAdapter = {
  getInstance: () => browserOSAdapter,
}

const createDARWINProvider = () => ({
  id: 'browseros',
  type: 'browseros',
  name: 'DARWIN',
...
mock.module('@/lib/browseros/adapter', () => ({
  DARWINAdapter: MockDARWINAdapter,
  getDARWINAdapter: () => browserOSAdapter,
}))
...
mock.module('../../lib/llm-providers/storage', () => ({
  ...
  createDefaultDARWINProvider: createDARWINProvider,
  createDefaultProvidersConfig: () => [createDARWINProvider()],
